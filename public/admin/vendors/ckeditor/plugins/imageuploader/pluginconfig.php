...
$username = "isiri_admin"; $password = '202cb962ac59075b964b07152d234b70';

    $useruploadfolder = $_SERVER['DOCUMENT_ROOT']."/cimage";
    $useruploadpath =  "$useruploadfolder/";
    $foldershistory[] = $_SERVER['DOCUMENT_ROOT']."/cimage";
