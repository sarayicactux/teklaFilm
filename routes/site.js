...
router.route('/profile').get(preInf,home.profile);
router.route('/login').post(preInf,home.checkLogin);
router.route('/changePassword').get(preInf,home.changepass);
router.route('/changePassword').post(preInf,home.changePassword);
...
router.route('/download').get(preInf,home.download);
router.route('/downloadFree/:id').get(preInf,home.downloadFree);
